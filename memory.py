...
class Memory:
    ...
    def __init__(self, interrupts=None, input_handler=None, apu=None, timer=None):
    ...
    def read_byte(self, address):
        ...
        if address < 0xC000:
            ...
            elif address == 0xFF04 or address == 0xFF05 or address == 0xFF06 or address == 0xFF07:
                # Timer registers (0xFF04-0xFF07)
                return self.timer.read_register(address) if self.timer else 0xFF
            elif address == 0xFF0F:
